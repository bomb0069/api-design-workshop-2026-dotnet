...
| 03-04 | [API Key Management](lab03-04-api-key-management/) | Key lifecycle: create → rotate (grace) → revoke, hashed storage, scopes, audit | ✅ Implemented |
...
| 03-07 | [Request Signing](lab03-07-request-signing/) | HMAC-SHA256 signed requests: integrity, replay window, constant-time compare | ✅ Implemented |
